...
>
    <SwitchPrimitive.Thumb
        ...
        class={cn(
            "data-[state=unchecked]:bg-text/35 data-[state=checked]:bg-text pointer-events-none block size-5.5 rounded-full ring-0 transition-[translate,background-color] duration-200 ease-in-out data-[state=checked]:translate-x-[calc(100%+2px)] data-[state=unchecked]:translate-x-0.5",
        )}
    />
</SwitchPrimitive.Root>
